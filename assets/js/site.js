(() => {
  ...
  if (!badge) {
    ...
    badge.innerHTML = `<strong>Debug-Build ${DBG_VERSION}</strong><span>${pageMap[currentPath] || (document.body.dataset.page || 'Seite')}</span><span>Stylesheet: styles.css?v=dbg34</span><span>Debug-Badge unten rechts</span><span>FiveM: yg8z9k · Discord: YhVeud3Suz</span>`;
})();
