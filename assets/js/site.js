(() => {
  ...
  if (!badge) {
    ...
    badge.innerHTML = `<strong>Debug-Build ${DBG_VERSION}</strong><span>${pageMap[currentPath] || (document.body.dataset.page || 'Seite')}</span><span>Stylesheet: styles.css?v=dbg33</span><span>Panel-Logos rechts sauber ausgerichtet · Hover fix</span><span>FiveM: yg8z9k · Discord: YhVeud3Suz</span>`;
})();
